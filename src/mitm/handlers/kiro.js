 ...
 * If 10router's Anthropic→OpenAI conversion passes the input as a pre-parsed object,
 ...
 *   3. Forward to 10router /v1/chat/completions (OpenAI SSE)
