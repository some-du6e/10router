...
// Resolve source files relative to the repo root, not vitest's cwd (which is
// tests/). srcPath("...") would otherwise look in tests/src/ → ENOENT.
const repoRoot = path.resolve(path.dirname(fileURLToPath(import.meta.url)), "../..");
const srcPath = (rel) => path.resolve(repoRoot, "src", rel);
