...
Pon en marcha 10router en 5 minutos y comienza a enrutar solicitudes de IA de forma inteligente.
...
Apunta tu herramienta de codificación a 10router:
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [desde el dashboard de 10router]
