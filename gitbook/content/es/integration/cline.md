...
Integra 10router con la extensión Cline de VSCode para enrutar tus solicitudes de IA a través del sistema de enrutamiento inteligente de 10router.

## Requisitos previos

- Visual Studio Code instalado
- Extensión Cline instalada desde el marketplace de VSCode
- 10router ejecutándose localmente o endpoint en la nube configurado
- API key del dashboard de 10router
...
**Para una instancia remota de 10router:**
```
https://your-10router-host
```

**Pasos:**
1. En el campo **Base URL**, ingresa tu endpoint de 10router
...
3. La key debe comenzar con `sk-10router-`

### 5. Seleccionar modelo

1. En el dropdown **Model**, puedes:
   - Seleccionar de los modelos disponibles (si Cline los auto-detecta)
   - Ingresar manualmente el nombre del modelo desde tu configuración de 10router
...
4. Cline usará 10router para procesar tu solicitud

### Generación de código

1. Pide a Cline que genere código: "Create a React component for a login form"
2. Cline generará código usando 10router
...
3. Obtén explicaciones potenciadas por IA a través de 10router

### Operaciones con archivos

1. Pide a Cline que cree, modifique o elimine archivos
2. Cline usará 10router para entender el contexto y hacer cambios
...
1. Verifica que 10router esté corriendo: `curl http://localhost:20128/health`
...
2. Verifica que tu instancia de 10router esté ejecutándose y saludable
3. Intenta recargar la ventana de VSCode (Cmd/Ctrl + Shift + P → "Reload Window")
4. Revisa los logs de 10router para cualquier error

## Configuración avanzada

### Usar un endpoint remoto

Para usar una instancia de 10router alojada por ti en otra máquina (VPS, servidor doméstico, túnel) en lugar de localhost:

1. En la configuración de Cline, establece Base URL a: `https://your-10router-host`
2. Asegúrate de haber creado tu API key en el dashboard de esa instancia
3. Asegúrate de que la instancia esté en ejecución y sea accesible desde tu máquina
...
## Integración con características de 10router

### Enrutamiento de modelos

10router enruta automáticamente tus solicitudes al mejor proveedor disponible según:
...
Si un proveedor falla, 10router automáticamente cambia a proveedores alternativos configurados en tu dashboard.

### Seguimiento de uso

Monitorea tu uso de Cline a través del dashboard de 10router:
