...
10router es compatible con cualquier herramienta que soporte el formato de API de OpenAI. Esta guía cubre patrones de integración genéricos para varias herramientas y aplicaciones personalizadas.

## Resumen

10router proporciona un endpoint de API compatible con OpenAI que funciona con:
...
Cualquier herramienta compatible con OpenAI puede conectarse a 10router usando estas configuraciones:

**10router local:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de 10router (cc/*, cx/*, glm/*, etc.)
```

**Instancia remota de 10router:**
```
...
**Problema:** No se puede conectar a 10router
```bash
# Verifica si 10router está corriendo
...
**Solución:**
- Verifica que 10router esté corriendo
...
- Verifica la conexión de red a 10router
