...
Despliega 10router en VPS o Docker para acceso remoto y uso en producción.
...
Crea `/etc/nginx/sites-available/10router`:
...
# Si NO usas proxy reverso, permite los puertos de 10router
...
```bash
# Verificar si 10router está corriendo
pm2 status
