...
Tích hợp 10router với extension Continue để mang trợ lý AI trực tiếp vào Visual Studio Code.

## Yêu cầu

- Visual Studio Code đã cài đặt
- Extension Continue đã cài đặt từ VSCode marketplace
- 10router API key từ [dashboard](http://localhost:20128/dashboard)
- 10router đang chạy (cục bộ hoặc cloud)
...
### 2. Thêm Cấu hình Model 10router
...
3. Chọn model 10router ưa thích
...
- Kiểm tra 10router đang chạy: `curl http://localhost:20128/health`
...
- Kiểm tra độ trễ network đến 10router
