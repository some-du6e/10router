...
10router tương thích với mọi công cụ hỗ trợ format API OpenAI. Hướng dẫn này bao gồm pattern tích hợp tổng quát cho nhiều công cụ và ứng dụng tùy chỉnh.

## Tổng quan

10router cung cấp API endpoint tương thích OpenAI hoạt động với:
...
Mọi công cụ tương thích OpenAI có thể kết nối đến 10router bằng các cài đặt sau:
...
**Vấn đề:** Không kết nối được đến 10router
```bash
...
- Kiểm tra kết nối network đến 10router
