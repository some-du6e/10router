...
Run 10router on your local machine for development and personal use.

---

## 📦 Installation

Install 10router globally via npm:
...
Start 10router with a single command:
...
- **Data Directory**: `~/.9router` (the directory name is unchanged from the previous release for backward compatibility)
...
Press `Ctrl+C` in the terminal where 10router is running.

```bash
# In the terminal running 10router
^C  # Press Ctrl+C
```
