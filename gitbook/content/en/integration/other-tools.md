...
10router is compatible with any tool that supports the OpenAI API format. This guide covers generic integration patterns for various tools and custom applications.

## Overview

10router provides an OpenAI-compatible API endpoint that works with:
...
Any OpenAI-compatible tool can connect to 10router using these settings:

**Local 10router:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: any 10router model (cc/*, cx/*, glm/*, etc.)
```

**Remote 10router instance:**
```
...
**Problem:** Cannot connect to 10router
```bash
...
- Check network connection to 10router
